...
std::optional<std::pair<size_t,std::shared_ptr<std::vector<char>>>> packaging_login(std::string username,std::string password,std::string time = "");
...
inline std::unordered_map<std::string,std::variant<std::string,int,bool>> ChatToRoom = {
    {"action","chat_to_room"},
    {"from",std::string{}},
    {"roomName",std::string{}},
    {"time",std::string{}},
...
std::optional<std::pair<size_t,std::shared_ptr<std::vector<char>>>> packaging(nlohmann::json&& j,std::shared_ptr<std::vector<char>> context);
std::optional<std::pair<size_t,std::shared_ptr<std::vector<char>>>> packaging_recv_chat_his(std::string roomName);
